...
Sprite S_CreateSquare(float size, const char* texFile, unsigned int color)
{
  if (texFile)
  {
    Sprite tmp_Square(CreateSquare(size, color), texFile, size, size);
    return tmp_Square;
  }
  else
  {
    Sprite tmp_Square(CreateSquare(size, color), size, size);
    return tmp_Square;
  }
}

//This function returns a sprite object with a rectangle mesh
Sprite S_CreateRectangle(float width, float height, const char* texFile, unsigned int color)
{
  if (texFile)
  {
    Sprite tmp_Rectangle(CreateRectangle(width, height, color), texFile, width, height);
    return tmp_Rectangle;
  }
  else
  {
    Sprite tmp_Rectangle(CreateRectangle(width, height, color), width, height);
    return tmp_Rectangle;
  }
}

//This function returns a sprite object with a platform mesh
Sprite CreatePlatform(float MultW, float MultH, const char* texFile, unsigned int color)
{
  if (texFile)
  {
    Sprite tmp_Rectangle(
      CreateRectangle(PLAT_WIDTH * MultW, PLAT_HEIGHT * MultH, color), 
  ...
  else
  {
    Sprite tmp_Rectangle(CreateRectangle(
      PLAT_WIDTH * MultW, PLAT_HEIGHT * MultH, color), 
...
Sprite CreateFloor(float MultW, const char* texFile, unsigned int color)
{
  if (texFile)
  {
    Sprite tmp_Rectangle(
      CreateRectangle(FLOOR_WIDTH * MultW, FLOOR_HEIGHT, color),
  ...
  {
    Sprite tmp_Rectangle(CreateRectangle(
      FLOOR_WIDTH * MultW, FLOOR_HEIGHT, color),
...
Sprite CreateBG(float MultW, const char* texFile, unsigned int color)
{
  if (texFile)
  {
    Sprite tmp_Rectangle(
      CreateRectangle(BG_WIDTH * MultW, BG_HEIGHT, color),
  ...
  {
    Sprite tmp_Rectangle(CreateRectangle(
      BG_WIDTH * MultW, BG_HEIGHT, color),
