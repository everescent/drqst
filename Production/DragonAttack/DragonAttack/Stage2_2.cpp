...
\brief
Implementation for the stage 2-2 game state.
...
namespace
{
	...
	Transform    *M_BG, *M_BG2, *M_BG3;		 // Transformation matrix for background texture
	...
	const AEVec2 startpos = { 4050, -2775 }; // The start position for the player
