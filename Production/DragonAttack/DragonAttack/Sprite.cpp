...
Sprite::Sprite(Sprite&& Move_Object)
  :Mesh  { Move_Object.Mesh   }, RM{ Move_Object.RM }, Tex  { Move_Object.Tex   },
   U     { Move_Object.U      }, V { Move_Object.V  }, Width{ Move_Object.Width },
...
{
  //Make sure I don't assign to myself
  if (this != &Move_Object)
  {
